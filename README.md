<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f172a,100:2563eb&height=220&section=header&text=Arjumand%20Mohiuddin&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=35" />
</p>

<h3 align="center">🚀 DevOps Engineer | AWS | Jenkins | Docker | Kubernetes | Terraform</h3>

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?size=22&center=true&vCenter=true&width=900&lines=Welcome+to+My+DevOps+World!;CI%2FCD+Automation+with+Jenkins+%F0%9F%9A%80;Cloud+Platforms:+AWS+%7C+Azure+%7C+GCP;Docker+%7C+Kubernetes+%7C+Terraform+%7C+Ansible;Always+Learning+%7C+Always+Building+%F0%9F%94%A5" />
</p>
...
|------------|-------------|------|
| 🔥 Jenkins CI/CD Pipeline | Automated CI/CD pipeline with build + deploy | Jenkins, Git, Docker |
| 🐳 Docker Multi-stage Build | Multi-stage Docker build for Java applications | Docker, Java |
| ☁️ Terraform AWS EC2 Setup | Automated AWS EC2 creation using Terraform | Terraform, AWS |
| 📦 Docker Compose Deployment | Deployed web apps using Docker Compose | Docker, Compose |
| 🔐 SonarQube Integration | Code quality analysis with Jenkins pipeline | Jenkins, SonarQube |
| 🚀 AWS ECR Push Project | Built and pushed Docker image into AWS ECR | AWS, Docker |
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=arjumand9794&label=Profile%20Views&color=2563eb&style=for-the-badge" />
</p>
...
> ⚡ "Automate everything that can be automated. Build systems that run themselves."
